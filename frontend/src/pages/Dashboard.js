    ...
    <Wrapper>
      ...
      <div className="p-5 mb-4 bg-light rounded-3">
        <div className="container-fluid py-5">
          ...
          <p className="col-md-12">This is a simple application that reminds people about thier Medicine intake. Uses Twilio API and SendGrid API to send SMS and Emails.
